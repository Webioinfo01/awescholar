...
awescholar updater citations --archive data.json --only "10.1038/x"  # Same scoping for citation backfill
...
awescholar updater export-agentx --archive data.json -o intake.sh --emit commands  # Shell script of pnpm agent:add lines instead of candidate JSON
