...
GitHub-enrichment and AgentX-bridge release — `updater enrich` links papers to their official GitHub repositories with live star counts, and `updater export-agentx` turns repo-backed papers into candidate agents for an AgentX-style registry.
